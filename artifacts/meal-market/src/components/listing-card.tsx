import { Listing, ListingStatus, useGetMe } from "@workspace/api-client-react";
    ...
    <Card className="flex flex-col h-full overflow-hidden hover:shadow-md transition-shadow duration-200 border-border group">
      ...
      <CardContent className="py-4 flex-1">
        ...
        <div className="space-y-1">
          <Link href={`/profile/${listing.sellerId}`} className="text-sm font-semibold hover:text-primary transition-colors flex items-center gap-2">
            {listing.sellerName}
          </Link>
